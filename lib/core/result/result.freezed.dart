...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( T data,  String? message)?  success,TResult Function( Exception error,  StackTrace? stackTrace)?  failure,required TResult orElse(),}) {final _that = this;
switch (_that) {
case Success() when success != null:
return success(_that.data,_that.message);case Failure() when failure != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( T data,  String? message)  success,required TResult Function( Exception error,  StackTrace? stackTrace)  failure,}) {final _that = this;
switch (_that) {
case Success():
return success(_that.data,_that.message);case Failure():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( T data,  String? message)?  success,TResult? Function( Exception error,  StackTrace? stackTrace)?  failure,}) {final _that = this;
switch (_that) {
case Success() when success != null:
return success(_that.data,_that.message);case Failure() when failure != null:
return failure(_that.error,_that.stackTrace);case _:
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Success<T>&&const DeepCollectionEquality().equals(other.data, data)&&(identical(other.message, message) || other.message == message));
}
...
as Exception,freezed == stackTrace ? _self.stackTrace : stackTrace // ignore: cast_nullable_to_non_nullable
as StackTrace?,
  ));
}
